...
def solve():
    ...
    def equation(*digits):
        ...
        return sum(value(word, assignment) for word in ['ONE', 'NINE', 'TWENTY', 'THIRTY', 'THIRTY']) == sum(value(word, assignment) for word in ['NINETY'])
...
def main():
    for solution in solve():
        print('ONE + NINE + TWENTY + THIRTY + THIRTY = NINETY', solution)
