...
def solve():
    ...
    def equation(*digits):
        ...
        return sum(value(word, assignment) for word in ['HERE', 'THEY', 'GO']) == sum(value(word, assignment) for word in ['AGAIN'])
...
def main():
    for solution in solve():
        print('HERE + THEY + GO = AGAIN', solution)
