...
def solve():
    ...
    def equation(*digits):
        ...
        return sum(value(word, assignment) for word in ['EIGHT', 'EIGHT', 'TWO', 'ONE', 'ONE']) == sum(value(word, assignment) for word in ['TWENTY'])
...
def main():
    for solution in solve():
        print('EIGHT + EIGHT + TWO + ONE + ONE = TWENTY', solution)
