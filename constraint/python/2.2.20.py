...
def solve():
    ...
    def equation(*digits):
        ...
        return sum(value(word, assignment) for word in ['THREE', 'THREE', 'ONE']) == sum(value(word, assignment) for word in ['SEVEN'])
...
def main():
    for solution in solve():
        print('THREE + THREE + ONE = SEVEN', solution)
