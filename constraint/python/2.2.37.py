...
def solve():
    ...
    def equation(*digits):
        ...
        return sum(value(word, assignment) for word in ['FIFTY', 'EIGHT', 'EIGHT', 'TEN', 'TWO', 'TWO']) == sum(value(word, assignment) for word in ['EIGHTY'])
...
def main():
    for solution in solve():
        print('FIFTY + EIGHT + EIGHT + TEN + TWO + TWO = EIGHTY', solution)
